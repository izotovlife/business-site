...
- Логин и выход выполняются через встроенные пути `/accounts/login/` и `/accounts/logout/`, после входа пользователь направляется на генерацию одноразовой ссылки.
